...
import 'package:admin_app/cubits/main_cubit/main_states.dart';
...
class MainCubit extends Cubit<MainStates> {
  ...
  List<ProductModel> findProductsByCat({required String catName}){
    List<ProductModel> catList = _products.where((element) => element.productCategory.toLowerCase().contains(catName.toLowerCase())).toList();
    return catList; 
  }
