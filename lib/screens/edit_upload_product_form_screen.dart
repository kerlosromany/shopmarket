...
class _EditOrUploadProductScreenState extends State<EditOrUploadProductScreen> {
  ...
  void initState() {
    ...
    if (widget.productModel != null) {
      ...
      pruductStatusVar = widget.productModel!.productStatus;
    }
    _titleController =
    ...
    if (isValid) {
      ...
      try {
        ...
        await FirebaseFirestore.instance
          ...
          "productStatus": pruductStatusVar,
        });
  ...
  List<DropdownMenuItem<bool>> statusDropDownList = [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        DropdownButton<bool>(
                          hint: Text(pruductStatusVar ? "متوفر" : "غير متوفر"),
                          value: pruductStatusVar,
                          items: statusDropDownList,
                          onChanged: (bool? value) {
                            setState(() {
                              pruductStatusVar = value!;
                            });
                          },
                        ),
                      ],
